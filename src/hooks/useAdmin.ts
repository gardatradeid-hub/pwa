...
export function useUpdateUser() {
  ...
  return useMutation({
    mutationFn: (params: { user_id: string; evaluation_tier?: number; current_phase?: number; rule_overrides?: Record<string, number>; onboarding_completed?: boolean; exchange?: string }) =>
